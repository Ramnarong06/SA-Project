...
//import Receipt from '../test/Test1';
//import { items } from '../test/Test2';
...
import glogo from '../../assets/exchange.gif';
      ...
      if (paymentResponse.status === 200) {
        ...
        if (updateResponse.status === 200) {
          message.success({
            content: (
            <div style={{ display: 'flex', alignItems: 'center', fontSize: '15px' ,color:'#22225E'}}>
              <img src={`${taptopay}?${Date.now()}`}  alt="Success" style={{ width: '40px', height: '40px', marginRight: '8px' }}/>
            ...
            <div className="payment-summary">
              ...
              <div className="summary-item installment">
                <div><p className="summary-title">ผ่อนจ่าย</p>
                    <p className="summary-title total">สุทธิ {payment?.PrintInstallment} บาท</p>
                </div>
