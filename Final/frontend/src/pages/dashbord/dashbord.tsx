...
const cardData = [
  { 
    ...
    hiddenDetails: [
      { header: 'ตรวจสุขภาพฟันและช่องปาก', price: 'เริ่มต้น ไม่คิดค่าใช้จ่าย', content: 'การตรวจสุขภาพฟันและช่องปากอย่างละเอียดเพื่อประเมินสภาพสุขภาพช่องปากทั้งหมด รวมถึงการตรวจหาฟันผุและโรคเหงือก ช่วยให้คุณมีสุขภาพฟันที่ดีตลอดไป' },
    ]
  },
  { 
    title: 'ครอบฟัน', 
  ...
  { 
    ...
    hiddenDetails: [
      { header: 'เคลือบฟลูออไรด์', price: 'เริ่มต้น 800 บาท', content: 'การเคลือบฟลูออไรด์จะช่วยเสริมความแข็งแรงให้กับฟันของคุณ ลดความเสี่ยงในการเกิดฟันผุและทำให้ฟันของคุณมีสุขภาพดีขึ้น' },
    ]
  },
  { 
    title: 'อุดฟัน ถอนฟัน', 
  ...
  { 
    ...
    hiddenDetails: [
      { header: 'จัดฟัน', price: 'เริ่มต้น 70,000 บาท', content: 'การจัดฟันช่วยปรับโครงสร้างฟันให้เข้าที่ ช่วยให้รอยยิ้มของคุณสวยงามและมั่นใจมากขึ้น' },
  ...
  { 
    ...
    hiddenDetails: [
      { header: 'ขูดหินปูนและขัดฟัน', price: 'เริ่มต้น 1,200 บาท', content: 'การขูดหินปูนและขัดฟันจะช่วยทำความสะอาดฟันอย่างละเอียด โดยช่วยกำจัดคราบหินปูนและทำให้ฟันของคุณมีสุขภาพดีและสดใส' },
    ]
  },
  { 
    title: 'ผ่าฟันคุด', 
